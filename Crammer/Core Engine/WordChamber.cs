...
namespace MB.Crammer
{
    class WordChamber
    {
        ...
        public static int BufferUpSize
        {
            get
            {
                return (Properties.Settings.Default.LargeChambers == true ? BUFFER_SPACE_FOR_PROPAGATION_PURPOSES * 2 : BUFFER_SPACE_FOR_PROPAGATION_PURPOSES);
            }
        }
        #endregion
        ...
        public static int chamber(ChamberType c)
        {
            ...
            {
                case ChamberType.C0:
                    return (Properties.Settings.Default.LargeChambers == true ? BIG_K0_CHECK : K0_CHECK);
                case ChamberType.C1:
                    return (Properties.Settings.Default.LargeChambers == true ? BIG_K1_CHECK : K1_CHECK);
                case ChamberType.C2:
                    return (Properties.Settings.Default.LargeChambers == true ? BIG_K2_CHECK : K2_CHECK);
                case ChamberType.C3:
                    return (Properties.Settings.Default.LargeChambers == true ? BIG_K3_CHECK : K3_CHECK);
                case ChamberType.C4:
                    return (Properties.Settings.Default.LargeChambers == true ? BIG_K4_CHECK : K4_CHECK);
                case ChamberType.C5:
                    return (Properties.Settings.Default.LargeChambers == true ? BIG_K5_CHECK : K5_CHECK);
